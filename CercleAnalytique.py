...
# conditions pour afficher le cercle
...
# dessine chaque octant du cercle de manière grâce à une symétrie entre x et y
def draw_circle(image, circle_center,circle_radius,width):
    #cette boucle 'for' permet de gerer l'épaisseur du cercle
